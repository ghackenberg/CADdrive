...
Again, the small and the large frame provide a standard interface for batteries represented by a standard sized hole in our digital LEGO models.
...
Finally, the small and the large frame also provide an interface for the small and the large cover represented by studs of certain LEGO bricks.
...
\begin{figure*}[tbp]
    \includegraphics[width=\textwidth]{./150_MODEL_11.jpg}
